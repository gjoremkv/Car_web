    ...
    <section className="after-main">
      <div className="vehicle-selection">
        ...
        <div className="filter-section">
          <div className="filter-item payment-label" style={{gridColumn: '1 / 5', textAlign: 'center', marginBottom: '0'}}>
            <label style={{fontWeight: 'bold', fontSize: '1.1rem', marginBottom: '0'}}>Payment method</label>
          </div>
          <div className="leasing-buy-toggle pill-style" style={{marginTop: '12px'}}>
